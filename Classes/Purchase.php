...
include 'connection.php';
	...
	function PurchaseDetails($invoice){
			$br_id = $_SESSION['id'];
			$sql = $this->con->query("SELECT * FROM tbl_purchase_details WHERE invoice='$invoice' AND br_id = '$br_id'");
			return $sql;
		}
		...
		function PurchaseSSummery($invoice){
			$br_id = $_SESSION['id'];
			$sql = $this->con->query("SELECT * FROM  tbl_purchase_summery WHERE invoice='$invoice' AND br_id = '$br_id'");
			return $sql;
		}
}