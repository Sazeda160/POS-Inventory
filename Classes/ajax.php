<?php 
	...
	function addItem(){
		...
		echo '<div class="alert alert-danger"> <strong> Error:</strong> Date Field is Not Empty </div>';

		}

		elseif($cName==""){

		echo '<div class="alert alert-danger"> <strong> Error:</strong> Company  Field is Not Empty </div>';

		}

		elseif($invoice==""){

		echo '<div class="alert alert-danger"> <strong> Error:</strong> Invoice Field is Not Empty </div>';

		}

		elseif($barcode==""){

		echo '<div class="alert alert-danger"> <strong> Error:</strong> Barcode Field is Not Empty </div>';

		}
		
		elseif($qnt==""){

		echo '<div class="alert alert-danger"> <strong> Error:</strong> Quantity Field is Not Empty </div>';
	...
	function purchaseSummery(){
       ...
       if($dis==""){
		...
		echo '<div class="alert alert-danger"> <strong> Error:</strong> Discount Field is Not Empty </div>';
	...
	function SaddItem(){
		...
		echo '<div class="alert alert-danger"> <strong> Error:</strong> Product Name Field is Not Empty </div>';
 ...
 function insertSalesSummery(){
	...
	$br_id = $_SESSION['id'];
	 ...
	 if($dis==""){
		...
		echo '<div class="alert alert-danger"> <strong> Error:</strong> Discount Name Field is Not Empty </div>';

		}


	elseif ($pay=="") {
			echo '<div class="alert alert-danger"> <strong> Error:</strong> Payment Name Field is Not Empty </div>';
		}
	...
	echo '<div class="alert alert-success"> <strong> Error:</strong> Sales and Print is Successful Done </div>';
